...
$VERSIONINFO:FILEVERSION#=2,8,65,2865
$VERSIONINFO:PRODUCTVERSION#=2,8,65,2865
$EXEICON:'data\icon.ico'
_ICON
LET hardbuild$ = "2.8.65"
...
IF _COMMANDCOUNT = 0 THEN
    ...
    IF ros$ = "lnx" THEN LET dloc$ = "data/": LET consolelog$ = "data/consolelog.txt"
    RETURN
END IF
DO
...
IF setupboot = 0 AND erasesave = 0 THEN GOSUB savetime
...
IF ros$ = "lnx" THEN SHELL _HIDE "ls -d */ > " + dloc$ + "modlist.tmp"
REM finds mods
...
IF ros$ = "lnx" THEN SHELL _HIDE "ls " + sloc$ + " > " + dloc$ + "oldsaves.tmp"
...
IF oldsaveamount = 0 THEN
    ...
    IF ros$ = "lnx" THEN SHELL _HIDE "rm " + dloc$ + "oldsaves.tmp"
    RETURN
END IF
IF oldsaveamount > 9 THEN
    ...
    DO
        ...
        IF findoldsave% THEN
            ...
            IF ros$ = "lnx" THEN SHELL _HIDE "rm " + sloc$ + temp48$
            REM tells console
...
DO
    ...
    IF findmakevalue% THEN
        ...
        LET temp13$ = RIGHT$(scriptline$, LEN(scriptline$) - LEN(temp12$))
        LET temp13$ = LTRIM$(temp13$)
        LET temp55$ = LEFT$(temp13$, INSTR(temp13$, " ") - 1)
        LET temp56$ = RIGHT$(temp13$, LEN(temp13$) - LEN(temp55$))
        LET temp55$ = LTRIM$(temp55$)
        LET temp56$ = LTRIM$(temp56$)
        LET temp151 = VAL(temp55$)
        LET temp152 = VAL(temp56$)
        IF finduserandom% THEN LET temp152 = randomscriptvalue: LET temp56$ = LTRIM$(STR$(temp152))
        LET scriptvalue(temp151) = temp152
        REM tells console 
        LET eventtitle$ = "VALUE " + temp55$ + " SET:"
        LET eventdata$ = "=" + temp56$
        LET eventnumber = 0
        GOSUB consoleprinter
        LET temp26 = 1
        LET temp55$ = "": LET temp56$ = "": LET temp151 = 0: LET temp152 = 0: REM scrub temp values
    END IF
    IF findmodvalue% THEN
        ...
        LET temp13$ = LTRIM$(temp13$)
        LET temp55$ = LEFT$(temp13$, INSTR(temp13$, " ") - 1)
        LET temp56$ = RIGHT$(temp13$, INSTR(temp13$, " "))
        LET temp55$ = LTRIM$(temp55$)
        LET temp56$ = LTRIM$(temp56$)
        LET temp151 = VAL(temp55$)
        LET temp152 = VAL(temp56$)
		...
		IF findadd% THEN
			REM adds amount
			LET scriptvalue(temp151) = scriptvalue(temp151) + temp152
			LET eventtitle$ = "VALUE " + temp55$ + " MOD:"
			LET eventdata$ = "+" + temp56$
			LET eventnumber = scriptvalue(temp151)
			GOSUB consoleprinter
			LET temp26 = 1
		END IF
    ...
    IF findmakerandom% THEN
		REM generates a random number in a predefined range
		LET temp12$ = LEFT$(scriptline$, INSTR(scriptline$, " ") - 1)
        LET temp13$ = RIGHT$(scriptline$, LEN(scriptline$) - LEN(temp12$))
        LET temp13$ = LTRIM$(temp13$)
        LET temp55$ = LEFT$(temp13$, INSTR(temp13$, " ") - 1)
        ...
        LET eventdata$ = "low: " + temp55$ + " high: " + temp56$
        LET eventnumber = 0
        GOSUB consoleprinter
        ...
        LET temp156 = 0
        DO
			IF temp154 < temp151 THEN LET temp154 = temp151
            IF temp154 > temp152 THEN LET temp154 = temp151
            LET temp155 = temp154
        ...
        LET temp26 = 1
        LET temp55$ = "": LET temp56$ = "": LET temp151 = 0: LET temp152 = 0: LET temp153 = 0: LET temp154 = 0: LET temp155 = 0: LET temp156 = 0: REM scrub temp values
    END IF
    ...
    IF findtimedscript% THEN
        ...
        LET temp13$ = RIGHT$(scriptline$, LEN(scriptline$) - LEN(temp12$))
        LET temp13$ = LTRIM$(temp13$)
        LET temp55$ = RIGHT$(temp13$, LEN(scriptline$) - LEN(temp12$ + temp13$) + 1)
        LET temp55$ = LTRIM$(temp55$)
        LET temp13$ = LEFT$(temp13$, INSTR(temp13$, " "))
        LET temp13$ = LTRIM$(temp13$)
        LET temp13$ = RTRIM$(temp13$)
        LET temp165 = VAL(temp55$)
        IF finduserandom% THEN LET temp165 = randomscriptvalue
        ...
        IF scripttimer > 0 THEN
            ...
            GOSUB consoleprinter
            LET temp26 = 1
            LET temp55$ = "": LET temp165 = 0
            GOTO scriptsay
        ELSE
            REM sets script timer values
            LET scripttimer = temp165
            LET scripttimername$ = temp13$
            LET iscripttimer = INT(ctime)
            REM tells console
    ...
    IF findterminaltext% THEN
        ...
        LET temp13$ = RIGHT$(scriptline$, LEN(scriptline$) - LEN(temp12$))
        LET temp13$ = LTRIM$(temp13$)
        LET txtfile1$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile1$) + 2))
        LET txtfile2$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile2$) + 2))
        LET txtfile3$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile3$) + 2))
        LET txtfile4$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile4$) + 2))
        LET txtfile5$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile5$) + 2))
        LET txtfile6$ = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
        LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(txtfile6$) + 2))
        LET sysstat = VAL(temp13$)
    ...
    IF findchoice% THEN
        ...
        DO
            LET x = x + 1
            LET choicename$(x) = LEFT$(temp13$, INSTR(temp13$, ",") - 1)
            LET temp13$ = RIGHT$(temp13$, LEN(temp13$) - (LEN(choicename$(x)) + 2))
        LOOP UNTIL INSTR(temp13$, ",") = 0
        LET choicename$(x + 1) = temp13$
        LET choicetotal = x + 1
        LET x = 1
        ...
        ELSE
            ...
            IF findbackchoice% THEN
                ...
                DO
                    ...
                    LET i = i + 1
                    LET temp56$ = MID$(scriptname$, i, 1)
                    LET temp57$ = temp57$ + temp56$
                    REM searches for last ifchoice
                    DO
                        LET findchoiceno% = INSTR(findchoiceno% + 1, temp57$, "-ifchoice")
    ...
    IF findrun% THEN
        ...
        IF ros$ = "lnx" THEN SHELL _HIDE "cp " + sloc$ + "options.ddf " + dloc$ + "utility/options.ddf"
        ...
        ELSE
            _FULLSCREEN _OFF
        END IF
        REM assigns permissions (linux only)
        ...
        IF ros$ = "lnx" THEN SHELL _HIDE "rm " + dloc$ + "utility/options.ddf"
    ...
    IF findtrigger% THEN
        ...
        IF finduserandom% THEN LET temp140 = randomscriptvalue
        IF findusevalue% THEN GOSUB scriptvaluefetcher: LET temp140 = fetchedvalue
        IF findon% THEN
            REM trigger on
            LET triggerd(temp140) = 1
        ...
        IF findoff% THEN
            ...
            LET temp26 = 1
        END IF
        LET temp140 = 0: REM scrub temp values
    END IF
    ...
    IF findcheckpoint% THEN
        ...
        IF findon% THEN
            ...
            IF findall% THEN
                ...
                FOR temp140 = 1 TO totalcheckpoints
                    LET checkpoint(temp140) = 1
                NEXT temp140
                LET temp26 = 1
            ELSE
    ...
    IF findifvalue% THEN
        ...
        LET temp55$ = LEFT$(temp13$, INSTR(temp13$, " ") - 1)
        LET temp56$ = RIGHT$(temp13$, LEN(temp13$) - LEN(temp55$))
        LET temp56$ = RIGHT$(temp56$, INSTR(temp56$, " ") + 1)
        LET temp55$ = LTRIM$(temp55$)
        LET temp56$ = LTRIM$(temp56$)
        LET temp151 = VAL(temp55$)
        LET temp152 = VAL(temp56$)
        ...
        IF findabove% THEN
			REM above
			IF scriptvalue(temp151) > temp152 THEN LET ifvalueresult = 1
		END IF
		IF findbelow% THEN
			REM below
			IF scriptvalue(temp151) < temp152 THEN LET ifvalueresult = 1
    ...
    IF findifrandom% THEN
		...
		LET temp12$ = RIGHT$(scriptline$, INSTR(scriptline$, " ") + 1)
        LET temp13$ = RIGHT$(temp12$, INSTR(temp12$, " ") - 1)
        LET temp13$ = LTRIM$(temp13$)
        LET temp140 = VAL(temp13$)
        LET ifrandomresult = 0
        IF findabove% THEN
			REM above
			IF randomscriptvalue > temp140 THEN LET ifrandomresult = 1
		END IF
		IF findbelow% THEN
			REM below
			IF randomscriptvalue < temp140 THEN LET ifrandomresult = 1
    ...
    IF findifcheckpoint% THEN
        ...
        IF checkpoint(temp140) = 1 THEN LET ifcheckpointresult = 1
    ...
    IF findwait% THEN
        ...
        GOSUB timeframecounter
        LET scriptwaittime = ctime + temp27
    ...
    IF findmove% OR findsprint% THEN
        ...
        IF findobject% THEN
            ...
            IF findx% THEN
                ...
                DO
                    LET x = x + 1
                    IF findobject(x) AND objectx(x) <> temp27 THEN
						IF scriptskip = 1 THEN LET objectx(x) = temp27: LET temp56 = 1
                        DO
							IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET objectx(x) = temp27: LET temp56 = 1
                            ...
                            GOSUB gameloop
                        LOOP UNTIL temp56 = 1
                        IF objectx(x) <> temp27 THEN LET objectx(x) = temp27
                        LET temp26 = 1
                    END IF
                LOOP UNTIL x >= mapobjectno
                LET x = 0
            ...
            IF findy% THEN
                ...
                DO
                    LET x = x + 1
                    IF findobject(x) AND objecty(x) <> temp27 THEN
						IF scriptskip = 1 THEN LET objecty(x) = temp27: LET temp56 = 1
                        DO
							IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET objecty(x) = temp27: LET temp56 = 1
                            ...
                            GOSUB gameloop
                        LOOP UNTIL temp56 = 1
                        IF objecty(x) <> temp27 THEN LET objecty(x) = temp27
                        LET temp26 = 1
                    END IF
                LOOP UNTIL x >= mapobjectno
                LET x = 0
        ...
        IF findplayer% THEN
            ...
            IF findx% THEN
                ...
                DO
                    LET x = x + 1
                    IF findplayer(x) AND playerx(x) <> temp27 THEN
                        LET playerwalking(x) = 1
                        IF scriptskip = 1 THEN LET playerx(x) = temp27: LET temp56 = 1
                        DO
							IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET playerx(x) = temp27: LET temp56 = 1
                            ...
                            GOSUB gameloop
                        LOOP UNTIL temp56 = 1
                        IF playerx(x) <> temp27 THEN LET playerx(x) = temp27
            ...
            IF findy% THEN
                ...
                DO
                    LET x = x + 1
                    IF findplayer(x) AND playery(x) <> temp27 THEN
						IF scriptskip = 1 THEN LET playery(x) = temp27: LET temp56 = 1
                        LET playerwalking(x) = 1
                        DO
							IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET playery(x) = temp27: LET temp56 = 1
                            ...
                            GOSUB gameloop
                        LOOP UNTIL temp56 = 1
                        IF playery(x) <> temp27 THEN LET playery(x) = temp27
                        LET playerwalking(x) = 0
                        LET temp26 = 1
                    END IF
                LOOP UNTIL x >= mapplayerno
        ...
        IF findmainplayer% THEN
            ...
            END IF
            IF findx% THEN
				IF scriptskip = 1 THEN LET posx = ((resx / 2) - temp27)
                IF ((resx / 2) - posx) > temp27 THEN
                    ...
                    LET mpwalking = 1
                    DO
						IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET posx = ((resx / 2) - temp27)
            ...
            END IF
            IF findy% THEN
				IF scriptskip = 1 THEN LET posy = ((resy / 2) - temp27)
                IF ((resy / 2) - posy) > temp27 THEN
                    ...
                    LET mpwalking = 1
                    DO
						IF _KEYDOWN(bcontrolcode1) OR _KEYDOWN(bcontrolcode2) OR _KEYDOWN(bcontrolcode3) OR _KEYDOWN(bcontrolcode4) THEN IF skipallowed = 1 THEN LET scriptskip = 1: LET posy = ((resy / 2) - temp27)
